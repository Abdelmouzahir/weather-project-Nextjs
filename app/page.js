...
export default function Home() {
  ...
  if (Object.keys(data).length === 0 && error === "") {
    ...
    content = (
      <div className="text-white text-center h-screen mt-[5rem]">
        ...
        <img src="/pngwing.com.png" alt="Error" className="w-80 h-80 mx-auto" />
      </div>
    );
  } else {
    content = (
  ...
  return (
    <div className="flex bg-cover bg-gradient-to-r from-blue-500 to-blue-300 h-fit outer-container">
